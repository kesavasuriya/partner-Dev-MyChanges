...
import getplacementContacts from '@salesforce/apex/GetProviderCommunityInfos.getPlacementContacts';
const columns = [
    ...
    { label: 'Date Of Birth', fieldName: 'dob', type: 'date', sortable: true,typeAttributes: { day: 'numeric', month: 'numeric', year: 'numeric', timeZone: 'UTC' } },
...
export default class GetCommunityContact extends LightningElement {
    ...
    connectedCallback() {
        ...
        getContactRec({providerId : this.providerId}) 
        .then(result => {
